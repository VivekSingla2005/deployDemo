...
const ParticlesComponent = (props) => {
  ...
  return (
    <div
      style={{
        position: 'relative', // Ensures it's relative to its parent
        width: '100%', // Takes up the full width of the parent
        height: '100%', // Takes up the full height of the parent
        background: 'linear-gradient(to bottom right, #0284c7, #14b8a6, #164e63)', // Apply gradient here
        backgroundOpacity: 0.8,
        zIndex:0, // Ensures it doesn't cover other content
      }}
    >
